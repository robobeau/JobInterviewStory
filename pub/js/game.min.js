...
var NPC = (function () {
    ...
    NPC.prototype.talk = function (dialogue) {
        if (this.talking) {
            return;
        }
        this.talking = true;
...
var Modals = (function () {
    ...
    Modals.prototype.create = function (size, position, dialogue, npc) {
        var delay = 0;
...
var Modal = (function () {
    ...
    Modal.prototype.populate = function (dialogue) {
        var _this = this;
            ...
            case 'flavor':
                ...
                var interval = setInterval(function () {
                    if (_this.cancelTyping) {
                        ...
                        _this.typing = false;
                        _this.self.append(dialogue.text.substr(counter, dialogue.text.length));
                        _this.self.append(_this.continueIcon);
                        clearInterval(interval);
                        return;
                    }
                    ;
                    _this.self.append(dialogue.text.charAt(counter));
                    sounds.fx.bip.play();
                    counter++;
...
var Sounds = (function () {
    ...
    Sounds.prototype.playMusic = function () {
        ...
        }, music[this.currentMusicId], null);
    };
    return Sounds;
})();
