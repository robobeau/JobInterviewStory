    ...
    Modal.prototype.destroy = function (focus) {
        ...
        this.self.animate({
            ...
            if (_this.type !== 'notification') {
                ...
                if (_this.npc) {
                    var npcData = _this.npc.data('npc');
            ...
            if (typeof _this.dialogue.action === 'function') {
                _this.dialogue.action();
            }
            if (focus) {
                focus.trigger('focus');
            }
...
var Battles = (function () {
    ...
    Battles.prototype.create = function (data) {
